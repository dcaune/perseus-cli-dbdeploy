...
public class MaximumExecutionAttemptException extends Exception {
  public MaximumExecutionAttemptException(SQLStatement sqlStatement) {
    super(sqlStatement.m_sqlExpression);
  }
}