...
public class SubversionRevisionControlSystem implements RevisionControlSystem {
  /**
   * Regular expression that matches the definition of a Subversion
   ...
   * a Subversion revision keyword declared in a source code.
   */
